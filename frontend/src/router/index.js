...
const routes = [
  ...
  { path: '/knowledge/:kbId/documents', name: 'KnowledgeDocuments', component: () => import('../views/KnowledgeDocuments.vue'), meta: { icon: '📄', label: '文档列表', roles: ['ADMIN', 'KB_EDITOR', 'KB_VIEWER', 'USER'], scope: 'rag:doc:read', orgSwitchFallback: '/knowledge' } },
  ...
  { path: '/document/:id', name: 'DocumentDetail', component: () => import('../views/DocumentDetail.vue'), meta: { icon: '📄', label: '文档详情', roles: ['ADMIN', 'KB_EDITOR', 'KB_VIEWER', 'USER'], scope: 'rag:doc:read', orgSwitchFallback: '/knowledge' } },
  ...
  { path: '/perf-probe', name: 'PerformanceProbe', component: () => import('../views/PerformanceProbe.vue'), meta: { icon: '⏱', label: '性能诊断', orgRoles: ['OWNER', 'ADMIN', 'MEMBER'] } },
  { path: '/eval', name: 'EvaluationLab', component: () => import('../views/EvaluationLab.vue'), meta: { icon: '🧪', label: '评测实验室', orgRoles: ['OWNER', 'ADMIN', 'MEMBER'] } },
  { path: '/evaluation/quality', name: 'EvaluationQuality', component: () => import('../views/EvaluationQuality.vue'), meta: { icon: '📈', label: '质量看板', roles: ['ADMIN', 'KB_EDITOR', 'KB_VIEWER', 'USER'] } },
  { path: '/evaluation/quality/case/:id', name: 'EvaluationQualityCase', component: () => import('../views/EvaluationQualityCase.vue'), meta: { icon: '🧪', label: '案例详情', roles: ['ADMIN', 'KB_EDITOR', 'KB_VIEWER', 'USER'], orgSwitchFallback: '/evaluation/quality' } },
  { path: '/models', name: 'ModelCostCenter', component: () => import('../views/ModelCostCenter.vue'), meta: { icon: '🧠', label: '模型 & 成本', roles: ['ADMIN', 'KB_EDITOR', 'KB_VIEWER', 'USER'] } },
