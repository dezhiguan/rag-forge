...
const routes = [
  ...
  { path: '/answer', name: 'AnswerPlayground', component: () => import('../views/AnswerPlayground.vue'), meta: { icon: '💬', label: '应答调试台', roles: ['ADMIN', 'KB_EDITOR', 'KB_VIEWER'], scope: 'rag:debug:run' } },
