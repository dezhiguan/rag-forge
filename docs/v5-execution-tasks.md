...
- T12 ✅ pending-commit 2026-06-22（V5 收口：文档真实口径 + api/worker role + Prometheus/Grafana；DashScope 累计成本待生产账单补录；Cost monitor dashboard 已提供，目标集群未部署 Grafana）
- T10-rewrite e2e ✅ 70d4c6c 2026-06-21 (14 用例通过 + 5 注入验证清单)
- T11 ✅ pending-commit 2026-06-21
